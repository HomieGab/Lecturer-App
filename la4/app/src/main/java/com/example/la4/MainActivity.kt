...
class MainActivity : AppCompatActivity() {
    ...
    private val requestPermissionLauncher = registerForActivityResult(
        ...
        if (permissions.all { it.value }) {
            // All permissions are granted, proceed with the rest of the functionality
            initializeApp()
        } else {
    ...
    private fun checkPermissions() {
        when {
            ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_WIFI_STATE) == PackageManager.PERMISSION_GRANTED &&
                ...
                // Permissions are already granted, proceed with the rest of the functionality
                initializeApp()
            }
            else -> {
                // Request permissions
    ...
    private fun initializeApp() {
        ...
        // Retrieve and display WiFi address and password
        displayWifiInfo()

        // Generate hashed student IDs
        ...
        // Check WiFi Direct state and navigate accordingly
